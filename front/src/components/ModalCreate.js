...
export default class ModalCreate extends Component {
  ...
  render() {
    return (
      <Modal isOpen={this.props.createModal} toggle={this.props.toggleCreateModal}>
        <ModalHeader toggle={this.toggleCreateModal}>Add new user</ModalHeader>
        <ModalBody>
          <Form>
              <FormGroup>
        ...
        <ModalFooter>
          <Button color="primary" onClick={this.props.createAction}>Create</Button>
          <Button color="secondary" onClick={this.props.toggleCreateModal}>Cancel</Button>
        </ModalFooter>
      </Modal>
    );
  }
